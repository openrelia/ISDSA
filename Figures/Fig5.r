## This script required WeibullR development version 1.0.11.7 at the time of presentation
## It utilizes function p2y to plot points and lines on specified wblr object canvas options.
